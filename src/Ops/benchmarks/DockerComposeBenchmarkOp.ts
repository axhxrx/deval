...
/**
Benchmark for Docker Compose Ops
*/
export class DockerComposeBenchmarkOp extends CommandSequenceBenchmarkOp
{
  constructor(options: {
    target?: string;
    quick?: boolean;
  ...
  } = {})
  {
    ...
    super({
      name: 'Docker Compose',
      description: 'Measures time for Docker Compose Ops',
      commands,
...
if (import.meta.main)
{
  const op = new DockerComposeBenchmarkOp({
    quick: true,
  });
